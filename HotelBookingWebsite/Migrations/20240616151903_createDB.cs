    ...
    public partial class createDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FirstName = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: false),
                    LastName = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    RoleName = table.Column<string>(type: "varchar(8)", unicode: false, maxLength: 8, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SideOptions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RoomTypeSideOptions",
                columns: table => new
                {
                    RoomTypeId = table.Column<short>(type: "smallint", nullable: false),
                    SideOptionId = table.Column<int>(type: "int", nullable: false),
                    Unit = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomTypeSideOptions", x => new { x.RoomTypeId, x.SideOptionId });
                    table.ForeignKey(
                        name: "FK_RoomTypeSideOptions_RoomTypes_RoomTypeId",
                        column: x => x.RoomTypeId,
                        principalTable: "RoomTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomTypeSideOptions_SideOptions_SideOptionId",
                        column: x => x.SideOptionId,
                        principalTable: "SideOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeSideOptions_SideOptionId",
                table: "RoomTypeSideOptions",
                column: "SideOptionId");
        }
